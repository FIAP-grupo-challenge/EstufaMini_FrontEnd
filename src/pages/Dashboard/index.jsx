...
export function Dashboard() {
  ...
  return (
    <div className="vh-100 d-flex flex-column justify-content-between text-center bg-dark page">
      ...
      <Header />
      {/* main */}
      <main className="container-fluid m-0 bg-dark">
        {/* nome + grafico */}
        <section className="row row-cols g-4 p-2 d-flex justify-content-between">
          <div className="col-xl-2 col-md-3">
            <div className="card bg-transparent border border-light text-light">
              <div className="card-body">
                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-flower3 text-success" viewBox="0 0 16 16">
      ...
      <footer className="border-top border-light bg-dark text-bottom p-3">
