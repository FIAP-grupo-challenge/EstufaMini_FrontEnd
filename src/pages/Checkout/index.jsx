      ...
      <main className="container">
        ...
        <section>
          <h1 className='text-center'>
            Mini Estufa inteligente - estufamini®
          </h1>
          <div className='text-center'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-half text-success" viewBox="0 0 16 16">
        ...
        <section className='row row-cols-lg-2 m-3'>
          ...
          <div className="row d-flex flex-column images-estufa">
            <div className="col d-flex justify-content-center">
              <img src={MiniEstufa} alt="Gabinete frontal" className="estufaMini" />
            </div>
            {/* exemplos */}
            <div className="d-flex col text-center my-5 p-0">
              <div className="cols-sm w-100">
                <img src={Gabinete} alt="Costas do gabinete" className='examples' />
              </div>
              <div className="cols-sm w-100" >
                <img src={ExampleInside} alt="componentes internos do gabinete" className='examples' />
              </div>
              <div className="cols-sm w-100 " >
                <img src={ExampleOut} alt="componentes externos" className='examples' />
              </div>
            </div>
          </div>
          < Sell />
