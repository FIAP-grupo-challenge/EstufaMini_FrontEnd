    ...
    <header className="border-bottom border-light">
      <nav className="navbar navbar-dark bg-dark p-2">
        <div className="container-fluid p-3">
          <button className="navbar-toggler bg-success" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-sliders2 text-light" viewBox="0 0 16 16">
          ...
          <div className="offcanvas offcanvas-start text-bg-dark" tabIndex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            <div className="offcanvas-header bg-dark">
              <h5 className="offcanvas-title" id="offcanvasDarkNavbarLabel">Miniestufa</h5>
